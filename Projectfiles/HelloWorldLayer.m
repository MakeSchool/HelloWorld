...
//this method gets called every frame thanks to the [self scheduleUpdate]; line you just pasted in
...

{
    ...
    //input will return 0,0 if there has been no touch. We check for that, and move the ship if there was a touch!
    if (pos.x != 0 && pos.y != 0)
